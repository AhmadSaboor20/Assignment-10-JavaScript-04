...
alert( null || 2 && 3 || 4 ); // output would be 3 reason:--null or 2 would be 2 beacue true returns first truth value and 3  or 4 would be 3 and then 2 and 3 would be check when and sees 2 is true then it will automatically prints the second value
